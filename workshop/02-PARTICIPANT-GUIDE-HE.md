...
בשלב התכנון עובדים ב-Plan Mode עם effort גבוה. אחרי אישור התוכנית עוברים ל-effort בינוני ומבצעים יחידות עבודה תחומות. אל תחברו production, אל תדביקו secrets ותנו רק את ההרשאות שנחוצות לעבודה.
...
3. מפעילים את ה-Skill, עוברים ל-effort בינוני ומבצעים את `PLAN.md` בצעדים תחומים.
